...
COMPANY = {
    ...
    # --- added to fix symbol extraction for all scanned names (HEROMOTOCO/BOSCHLTD etc.) ---
    "HEROMOTOCO": "Hero MotoCorp — two-wheelers. NSE: HEROMOTOCO.",
    "BOSCHLTD": "Bosch Ltd — auto components. NSE: BOSCHLTD.",
    "TATAPOWER": "Tata Power. NSE: TATAPOWER.",
    "TATASTEEL": "Tata Steel. NSE: TATASTEEL.",
    "BAJAJ-AUTO": "Bajaj Auto. NSE: BAJAJ-AUTO.",
    "EICHERMOT": "Eicher Motors — Royal Enfield. NSE: EICHERMOT.",
    "TVSMOTOR": "TVS Motor. NSE: TVSMOTOR.",
    "ASHOKLEY": "Ashok Leyland. NSE: ASHOKLEY.",
    "M&M": "Mahindra & Mahindra. NSE: M&M.",
    "BAJFINANCE": "Bajaj Finance. NSE: BAJFINANCE.",
    "ADANIENT": "Adani Enterprises. NSE: ADANIENT.",
    "ADANIPORTS": "Adani Ports. NSE: ADANIPORTS.",
    "HCLTECH": "HCL Technologies. NSE: HCLTECH.",
    "WIPRO": "Wipro. NSE: WIPRO.",
    "TECHM": "Tech Mahindra. NSE: TECHM.",
    "POWERGRID": "Power Grid Corp. NSE: POWERGRID.",
    "COALINDIA": "Coal India. NSE: COALINDIA.",
    "JSWSTEEL": "JSW Steel. NSE: JSWSTEEL.",
    "HINDALCO": "Hindalco. NSE: HINDALCO.",
    "VEDL": "Vedanta. NSE: VEDL.",
    "GRASIM": "Grasim. NSE: GRASIM.",
    "ULTRACEMCO": "UltraTech Cement. NSE: ULTRACEMCO.",
    "APOLLOHOSP": "Apollo Hospitals. NSE: APOLLOHOSP.",
    "DRREDDY": "Dr Reddy's. NSE: DRREDDY.",
    "CIPLA": "Cipla. NSE: CIPLA.",
    "DIVISLAB": "Divi's Lab. NSE: DIVISLAB.",
    "BRITANNIA": "Britannia. NSE: BRITANNIA.",
    "NESTLEIND": "Nestle India. NSE: NESTLEIND.",
    "TATACONSUM": "Tata Consumer. NSE: TATACONSUM.",
    "INDIGO": "InterGlobe Aviation (IndiGo). NSE: INDIGO.",
    "SBILIFE": "SBI Life. NSE: SBILIFE.",
    "HDFCLIFE": "HDFC Life. NSE: HDFCLIFE.",
    "ICICIGI": "ICICI Lombard. NSE: ICICIGI.",
    "ICICIPRULI": "ICICI Prudential Life. NSE: ICICIPRULI.",
}
...
ALIASES = {
    ...
    # --- hero motocorp: user's failing case (BOSCHLTD misfire) + typo tolerance ---
    "hero": "HEROMOTOCO", "hero moto": "HEROMOTOCO", "hero motocorp": "HEROMOTOCO",
    "hero motoco": "HEROMOTOCO", "heromoto": "HEROMOTOCO", "heromotoco": "HEROMOTOCO",
    "heromotocorp": "HEROMOTOCO", "hero motor": "HEROMOTOCO", "hero motors": "HEROMOTOCO",
    # typo: 'here' instead of 'hero' (phone STT)
    "here moto": "HEROMOTOCO", "here motor": "HEROMOTOCO", "here motocorp": "HEROMOTOCO",
    "here motoco": "HEROMOTOCO",
